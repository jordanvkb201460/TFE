 ...
 */
final class Version20190407152716 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE experience ADD date VARCHAR(255) DEFAULT NULL COMMENT \'(DC2Type:dateinterval)\'');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE experience DROP date');
    }
}
